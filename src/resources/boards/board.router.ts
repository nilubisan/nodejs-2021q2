...
boardRouter.route('/:boardId').delete((req, res) => {
...
boardRouter.route('/:boardId/tasks').get(async (req, res) => {
...
boardRouter.route('/:boardId/tasks').post(async (req, res) => {
...
boardRouter.route('/:boardId/tasks/:taskId').get(async (req, res) => {
...
boardRouter.route('/:boardId/tasks/:taskId').put(async (req, res) => {
...
boardRouter.route('/:boardId/tasks/:taskId').delete(async (req, res) => {
