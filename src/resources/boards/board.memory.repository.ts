...
export const getBoardById = async (boardId: string): Promise<Board | 'NOT FOUND'> => {
  const boardRepository = getRepository(Board);
...
export const updateBoard = async (boardId: string, board: Board): Promise<Board | 'NOT FOUND'> => {
  const boardRepository = getRepository(Board);
...
export const deleteBoard = async (boardId: string): Promise<'NOT FOUND' | 'DELETED'> => {
  const boardRepository = getRepository(Board);
